...
public class QHotel extends EntityPathBase<Hotel>
{
	...
	private static final long serialVersionUID = -306882436L;
	...
	public final NumberPath<Double> pricePerNight = createNumber("pricePerNight", Double.class);

	public final ListPath<Review, QReview> reviews = this.<Review, QReview>createList("reviews", Review.class,
